...
/**
 * Tipo de bloco Wood (Madeira).
 * Representa troncos de árvores no mundo.
 * Usa textura procedural castanha.
 */
public class WoodBlockType extends VoxelBlockType {
    ...
    // isSolid() herda true da classe base

    @Override
    public Material getMaterial(AssetManager assetManager) {
        // 1. Carregar a textura do ficheiro
        // O caminho é relativo à pasta 'resources'
        Texture2D tex = (Texture2D) assetManager.loadTexture("Textures/wood1.png");
